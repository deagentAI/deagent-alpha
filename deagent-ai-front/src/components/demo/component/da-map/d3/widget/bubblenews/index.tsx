...
import { useGetWidgetPos } from "@src/components/demo/hooks";
...
const Index: React.FC<Props> = (props) => {
  ...
  const cssAttr = useGetWidgetPos(DaWidgetComponentName.bubblenews) || {};
  const { x, y, ...rest } = cssAttr;
  return (
    <BaseLayout
      title="BubbleNewsHunter"
      targetUrl="/images/demo/bubble.png"
      bgUrl="/images/demo/bubble-bg.png"
