...
export const rpcUrl: string =
  "https://smart-floral-knowledge.solana-mainnet.quiknode.pro/d7322309f60ef837ccf578ca4261d0cedd11e7e6";
...
export const TOKEN_PROGRAM_PROJECT_ID = new PublicKey(
  process.env.NEXT_PUBLIC__PROJECT_KEY as string
);
